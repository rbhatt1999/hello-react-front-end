...
Clone this [repository](https://github.com/rbhatt1999/hello-react-front-end.git) to your desired folder:

```sh
  cd my-folder
  git clone https://github.com/rbhatt1999/hello-react-front-end.git 
...
Feel free to check the [issues page](https://github.com/rbhatt1999/hello-react-front-end/issues).
